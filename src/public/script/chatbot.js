        ...
        function sendMessage() {
            ...
            var historiChat = document.getElementById('user-message').innerText;

            // Menampilkan pesan dari pengguna
            var userMessageContainer = document.createElement('div');
            userMessageContainer.className = 'message-container user';
            userMessageContainer.innerHTML = '<div class="message user-message">' + userMessage + '</div>';
            ...
            botMessageContainer.innerHTML = '<div class="message bot-message">' + botResponse + '</div>';
            ...
            localStorage.setItem('histori_chatbot',  historiChat);
        }
        ...
        function toggleChat() {
            ...
            // Setelah perubahan ini, chatbot akan langsung terbuka tanpa animasi
    ...
    socket.on('chatMessage', (history) => {
      const chatHistoryDiv = document.getElementById('chatMessage');
      history.forEach((chat) => {
        chatHistoryDiv.innerHTML += `<div>${chat.message}</div>`;
      });
    });
    ...
    socket.on('chatMessage', (msg) => {
      const chatHistoryDiv = document.getElementById('chatMessage');
      chatHistoryDiv.innerHTML += `<div>${msg}</div>`;
    });
